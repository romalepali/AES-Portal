...
<?php
    ...
    {
        $sql_query="DELETE FROM level WHERE level_id=".$_GET['delete_id'];
...
<html>
    <head>
        ...
        <script src="../js/level-option.js"></script>
        <title>Levels</title>
    </head>
            ...
            <div style="display:none;" id="myDiv" class="animate-bottom">
                ...
                <div id="main">
                    ...
                    <div style="overflow:hidden;">
                        ...
                        <div class="main">
                            <h1 style="text-align:center;">Browse Levels</h1>
                            <div id="bylevel" style="margin: 20px auto; width:100%; padding:5px;">
                                ...
                                <div style="overflow:scroll; height:310px;">
                                    <table align="center">
                                        <?php
                                            $sql_query="SELECT a.* FROM level a GROUP BY level_description";
